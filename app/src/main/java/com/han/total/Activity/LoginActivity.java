...
public class LoginActivity extends AppCompatActivity {
     ...
     * client 정보를 넣어준다.
     */
    private static String OAUTH_CLIENT_ID = "0VUQhheUvYAcsn8iFSti";
    private static String OAUTH_CLIENT_SECRET = "MFoWsms1Ta";
    private static String OAUTH_CLIENT_NAME = "Running App";
